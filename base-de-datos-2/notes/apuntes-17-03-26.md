...
> **Ejemplo práctico:** Un _Cliente_ puede tener asociadas entre $0$ y muchas ($*$) _Tarjetas de Crédito_ (Cardinalidad: Muchos, Modalidad: Opcional). Pero cada _Tarjeta_ pertenece sí o sí a un ($1$) único _Cliente_ (Cardinalidad: Uno, Modalidad: Obligatoria).
