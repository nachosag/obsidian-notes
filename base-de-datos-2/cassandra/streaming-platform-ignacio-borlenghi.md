...
1. Listar todas las playlists creadas por un usuario, ordenadas por fecha de creación descendente.
...
1. Consultar el historial de reproducciones de un usuario en un país determinado, ordenado por fecha descendente.
...
```
   ...
   1. Insertar un usuario con sus géneros favoritos y dispositivos cargados.
...
```
   ...
   1. Insertar un segundo usuario con valores mínimos pero incluyendo al menos un género y un dispositivo.
...
```
   ...
   1. Obtener todos los datos del usuario por su user\_id.
...
```
   ...
   1. Obtener únicamente username, géneros favoritos y dispositivos.
...
```
   ...
   1. Agregar el género "classical" al SET favorite\_genres usando el operador \+.
...
```
   ...
   1. Eliminar el género "reggaeton" del SET favorite\_genres usando el operador \-.
...
```
   ...
   1. Reemplazar todo el contenido del SET favorite\_genres por uno nuevo.
...
```
   ...
   1. Agregar (o actualizar si ya existía) una entrada al MAP devices usando el operador \+.
...
```
   ...
   1. Actualizar la fecha de último uso de un dispositivo específico utilizando la sintaxis de acceso por clave.
...
```
   ...
   1. Eliminar una clave específica del MAP devices.
...
```
   ...
   1. Borrar únicamente la columna favorite\_genres del registro, sin eliminar el resto.
...
```
   ...
   1. Eliminar el registro completo del usuario.
...
```
   ...
   1. Obtener las canciones de una playlist específica de un usuario, ordenadas por posición en la playlist.
