...
```mermaid
flowchart TD
    %% Configuración de estilo global para emular el fondo oscuro y texto claro
    classDef default fill:#1e1e1e,stroke:#333,stroke-width:1px,color:#fff;
    
    Raiz["`**GARANTÍAS CONSTITUCIONALES (ART. 43)**`"]
    
    Sub1["`**HÁBEAS CORPUS**
    (Protección de la Libertad Física)
    Garantiza la libertad física y de locomoción
    de una persona ante arrestos arbitrarios,
    amenazas o desapariciones.`"]
    
    Sub2["`**HÁBEAS DATA**
    (Protección de la Información Personal)
    Permite conocer qué datos personales constan
    en registros públicos o privados de informes,
    y exigir su rectificación o confidencialidad.`"]

    %% Conexiones con trazos ortogonales limpios
    Raiz --> Sub1
    Raiz --> Sub2
```
