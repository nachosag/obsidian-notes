...
flowchart TD
    ...
    %% Reemplazamos el punto por guion para burlar el parser de listas de Obsidian
    Detalle_PU["1 - Estado Nacional, Provincial y Municipal<br>2 - Iglesia Católica<br>3 - Estados Extranjeros y entes de Derecho Público Int."]

    Detalle_PR["1 - Sociedades Comerciales<br>2 - Asociaciones Civiles<br>3 - Simples Asociaciones<br>4 - Fundaciones<br>5 - Cooperativas<br>6 - Consorcios de Prop. Horiz."]

    %% Conexiones y estructura jerárquica
    PJ --> PU
    PJ --> PR
    PU --- Detalle_PU
    PR --- Detalle_PR
