...
1. El comportamiento real ante un fallo de red: Imaginemos un escenario: tenés un cluster dividido en dos por un fallo de red. El lado A tiene 2 nods y el lado B tiene 1 nodo. No pueden hablar entre sí. ¿Qué hace cada motor?
